...
public class OrderDaoImpl implements OrderDao{
    ...
    public static final String INSERT_ORDER_QUERY="insert into public.shippingorder"
            + "(order_id, reference_order_id, truck_id, order_date, pickup_date, dropoff_date, payment_mode, expected_miles, actual_miles, service_fees, order_status, is_paid) "
            + "values(:order_id, :reference_order_id, :truck_id, :order_date, :pickup_date, :dropoff_date, :payment_mode, :expected_miles, :actual_miles, :service_fees, :order_status, :is_paid)";
